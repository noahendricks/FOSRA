...
from FOSRABack.src.retrieval.services.reranker_service import RerankResult
from FOSRABack.src.orchestration.conversational.convo_flow_nodes import (
    rerank_sources,
    answer_question,
...
from FOSRABack.src.resources.retrieval_fixtures import *
...
class TestRerankSources:
    ...
    async def test_sources_from_config_when_state_empty(
        ...
        with patch(
            "FOSRABack.src.orchestration.conversational.convo_flow_nodes.RerankerService"
...
class TestAnswerQuestion:
    ...
    @pytest.mark.asyncio
    @patch(
        "FOSRABack.src.orchestration.main_flow.main_flow_nodes.LLMService.get_llm_for_role"
    )
    ...
    @pytest.mark.asyncio
    @patch(
        "FOSRABack.src.orchestration.conversational.convo_flow_nodes.LLMService.get_llm_for_role"
    )
    ...
    @patch(
        "FOSRABack.src.orchestration.conversational.convo_flow_nodes.optimize_sources_for_token_limit"
    )
...
class TestConvoFlowIntegration:
    ...
    @patch("FOSRABack.src.orchestration.conversational.convo_flow_nodes.RerankerService")
    @patch(
        "FOSRABack.src.orchestration.conversational.convo_flow_nodes.LLMService.get_llm_for_role"
    )
