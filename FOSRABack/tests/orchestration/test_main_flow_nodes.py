...
from FOSRABack.src.orchestration.main_flow.main_flow_nodes import (
...
from FOSRABack.src.convo.utils.streaming_utils import StreamingService
from FOSRABack.src.orchestration.main_flow.main_flow_config import Configuration
from FOSRABack.src.resources.test_fixtures import mock_request_context
...
class TestFetchRelevantSources:
    ...
    async def test_fetch_with_streaming(
        ...
        with patch(
            "FOSRABack.src.orchestration.main_flow.mf_helpers.ConnectorService",
        ) as MockConnectorService:
            from FOSRABack.src.storage.schemas import OriginType
    ...
    @pytest.mark.asyncio
    @patch("FOSRABack.src.orchestration.main_flow.mf_helpers.ConnectorService")
...
#
#         with patch(
#             "FOSRABack.src.orchestration.main_flow.main_flow_nodes.fetch_sources_by_ids",
#             new_callable=AsyncMock,
#             return_value=([], []),
#         ):
#             with patch(
#                 "FOSRABack.src.orchestration.main_flow.main_flow_nodes.rerank_sources",
#                 new_callable=AsyncMock,
...
#
#                 with patch(
#                     "FOSRABack.src.orchestration.main_flow_nodes.selected_fast_llm",
#                     new_callable=AsyncMock,
...
#         ):
#             with patch(
#                 "FOSRABack.src.orchestration.main_flow.main_flow_nodes.convo_rerank_sources",
#                 new_callable=AsyncMock,
...
#                 ):
#                     with patch(
#                         "FOSRABack.src.orchestration.main_flow_nodes.optimize_sources_for_token_limit",
...
#         ):
#             with patch(
#                 "FOSRABack.src.orchestration.main_flow_nodes.convo_rerank_sources",
#                 new_callable=AsyncMock,
#                 return_value={"reranked_sources": []},
#             ):
#                 with patch(
...
class TestReformulateUserQuery:
    ...
    async def test_no_chat_history(self, mock_state, mock_config):
        ...
        with patch(
            "FOSRABack.src.orchestration.main_flow.main_flow_nodes.QueryService"
        ) as MockQueryService:
...
class TestGenerateFurtherQuestions:
    ...
    async def test_successful_generation(self, mock_state, mock_config, mock_writer):
        ...
        with patch(
            "FOSRABack.src.orchestration.main_flow.main_flow_nodes.LLMService"
        ) as MockLLMService:
    ...
    @pytest.mark.asyncio
    @patch("FOSRABack.src.orchestration.main_flow.main_flow_nodes.LLMService")
