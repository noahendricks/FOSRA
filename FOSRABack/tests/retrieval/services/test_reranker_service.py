...
from FOSRABack.src.retrieval.services.reranker_service import (
    APIReranker,
    BaseReranker,
    CohereReranker,
...
class TestFlashRankReranker:
    ...
    @pytest.mark.asyncio
    @patch(
        "FOSRABack.src.retrieval.services.reranker_service.FlashRankReranker._initialize_reranker"
    )
...
class TestCohereReranker:
    ...
    #         with patch(
    #             "FOSRABack.src.retrieval.services.reranker_service.CohereReranker.rerank",
