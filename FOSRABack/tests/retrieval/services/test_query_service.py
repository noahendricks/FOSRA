...
from FOSRABack.src.config.request_context import RequestContext

from FOSRABack.src.retrieval.services.query_service import (
    FusionRetriever,
    MetadataFilter,
    QueryExpander,
    QueryService,
...
class TestQueryExpander:
    ...
    @pytest.mark.asyncio
    @patch("FOSRABack.src.retrieval.services.query_service.QueryExpander._get_llm")
...
class TestQueryService:
    ...
    @pytest.mark.asyncio
    @patch("FOSRABack.src.convo.services.llm_service.LLMService.get_llm_for_role")
