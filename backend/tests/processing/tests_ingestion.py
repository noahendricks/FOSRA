...
# from backend.src.storage.database import SQLSessionManager
# from backend.src.storage.models import ChunkORM, SourceORM
# from unittest.mock import AsyncMock, MagicMock, patch
#
# from backend.src.processing.parse import process_source_in_background
# from backend.src.processing.utils.processing_utils import generate_content_hash
...
#     SparseVector,
# )
# from backend.src.storage.vector_service import VectorRepo
#
#
...
#
# @pytest.mark.asyncio
# @patch("backend.src.processing.parse.state.vector_service")
# @patch("backend.src.processing.utils.processing_utils.config.EMBEDDING_MODEL_INSTANCE")
# @patch("backend.src.config.config.EMBEDDING_MODEL_INSTANCE")
# @patch("backend.src.processing.parse.selected_heavy_llm")
# @patch("backend.src.processing.parse.ChunkerManager")
# @patch("backend.src.processing.parse.Embedder")
...
#     from backend.src.storage.models import UserORM, WorkspaceORM
#
#     test_user = UserORM(
#         user_id="user_123",
#         name="Test User",
...
#     from backend.src.storage.models import OriginORM
#
...
# @patch("backend.src.processing.parse.ChunkerManager")
# @patch("backend.src.processing.parse.Embedder")
# @patch("backend.src.processing.utils.processing_utils.convert_document_to_markdown")
# @patch("backend.src.processing.parse.UnstructuredFileLoader")
# @patch("backend.src.config.config.ETL_SERVICE", "UNSTRUCTURED")
...
# @patch("backend.src.processing.parse.ChunkerManager")
# @patch("backend.src.processing.parse.Embedder")
# @patch("backend.src.convo.utils.docling_helper.DoclingService")
# @patch("backend.src.config.config.ETL_SERVICE", "DOCLING")
