...
from backend.src.config.request_context import ParserConfig
...
class TestDoclingParser:
    ...
    async def test_parse_success(self, sample_pdf_path: str):
        ...
        with patch(
            "backend.src.convo.utils.docling_helper.create_docling_service",
...
class TestLlamaParseParser:
    ...
    async def test_parse_no_api_config(self, sample_pdf_path: str):
        ...
        from backend.src.config.request_context import RequestContext, UserPreferences
