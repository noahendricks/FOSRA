...
from backend.src.config import app_state
from backend.src.config.request_context import VectorStoreType
from backend.src.convo.services.convo_service import ConvoService
from backend.src.convo.services.workspace_service import WorkspaceService
...
class TestGetContext:
    ...
    @patch("backend.src.convo.services.convo_service.app_state")
    @pytest.mark.asyncio
    ...
    async def test_get_context_passes_workspace_id(
        ...
        """
        with patch(
            "backend.src.convo.services.convo_service.app_state"
        ) as mock_app_state:
            mock_vector_service = AsyncMock()
            mock_vector_service.search.return_value = []
            mock_app_state.vector_service = mock_vector_service
