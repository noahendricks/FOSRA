...
from backend.src.retrieval.services.origin_service import (
    BaseStorageBackend,
    FilesystemBackend,
    HTTPBackend,
    OriginContent,
...
from backend.src.storage.schemas import ConnectorType, OriginType
...
class TestS3Backend:
    ...
    #     with patch(
    #         "backend.src.retrieval.services.origin_service.aiobotocore"
    #     ) as mock_aiobotocore:
...
class TestHTTPBackend:
    ...
    #     with patch("backend.src.retrieval.services.origin_service.httpx") as mock_httpx:
    #         mock_client = AsyncMock()
