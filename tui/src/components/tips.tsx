...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your session at opencode.ai",
  ...
  themeTip,
  "Press {highlight}Ctrl+X N{/highlight} or {highlight}/new{/highlight} to start a fresh session session",
  "Use {highlight}/sessions{/highlight} or {highlight}Ctrl+X L{/highlight} to list and continue previous sessions",
  "Run {highlight}/compact{/highlight} to summarize long sessions near context limits",
  "Press {highlight}Ctrl+X X{/highlight} or {highlight}/export{/highlight} to save the session as Markdown",
  ...
  "Use {highlight}PageUp{/highlight}/{highlight}PageDown{/highlight} to navigate through session history",
  "Press {highlight}Ctrl+G{/highlight} or {highlight}Home{/highlight} to jump to the beginning of the session",
